...
namespace AdaptiveMusicSample
{
    ...
    /// </summary>
    public sealed class AdaptiveMidiFile
    {
        ...
        public AdaptiveMidiFile(Stream stream)
        {
            if (stream == null)
            {
        ...
        public AdaptiveMidiFile(Stream stream, int loopPoint)
        {
            if (stream == null)
            {
                throw new ArgumentNullException(nameof(stream));
        ...
        public AdaptiveMidiFile(Stream stream, MidiFileLoopType loopType)
        {
            if (stream == null)
            {
                throw new ArgumentNullException(nameof(stream));
        ...
        public AdaptiveMidiFile(string path)
        {
            if (path == null)
            {
        ...
        /// <param name="path">The MIDI file name and path.</param>
        /// <param name="loopPoint">The loop start point in ticks.</param>
        public AdaptiveMidiFile(string path, int loopPoint)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="path">The MIDI file name and path.</param>
        /// <param name="loopType">The type of the loop extension to be used.</param>
        public AdaptiveMidiFile(string path, MidiFileLoopType loopType)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
